  ...
  return (
    <section className="container flex h-[32rem] items-center overflow-hidden rounded bg-[url('../public/home/homep1.webp')] bg-cover bg-center p-0">
      <div className="flex w-full flex-col gap-4 rounded-r bg-white p-8 md:w-1/2">
        ...
        <p>
          Applications for first semester Fall 2023/2024 are now open AAMBFS
          prides itself for graduating an extensive number of high-ranking
          leaders, notable decision makers and influencers who continue to drive
          their impact in different areas in the business world of today.
        </p>
      </div>
    </section>
  );
